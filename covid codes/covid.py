...
dfclass = remove_na_leaveonlyint(individual_details, 'age_bracket')
ind_det_obj1 = dfclass.remove_na_conv_str()
sns_plot = sns.distplot(ind_det_obj1['age_bracket'])
plt.tight_layout()
sns_plot.figure.savefig('age_distribution.jpg', dpi = 100)